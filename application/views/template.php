...
<meta property="fb:admins" content="pirongames"/>
...
<!--<script type="text/javascript" src="<?=base_url()?>res/js/jquery-1.7.2.min.js" charset="utf-8"></script>-->
...
<script type="text/javascript" src="<?=base_url()?>res/js/jquery.tools.min.js" charset="utf-8"></script>

<!-- Google +1 Button Script -->
<script type="text/javascript" src="http://apis.google.com/js/plusone.js"></script>

<script type="text/javascript">document.write("<scr" + "ipt type='text/javascript' src='http://www.epicgameads.com/ads/popjs.php?id=77i2MOIakN&channel=0&cb=" + new Date().getTime() + "'></scri" + "pt>");</script>
</head>
<body>
